  ...
  
{
    ...
    options: ["送受信機とアダプタが一緒に組み立てられた状態で、1つのLRUを構成する。", "ILS/TCNコントロールパネルは、座席の右側コンソールにある。", "タカン装置は、ドア3Rに搭載されている。"],
    correctOption: 2,
  },

{
    question: "5問目の質問:F-15の関連装置について、誤っているものを選べ",
    options: ["F-15DJの場合、前席または後席において、制御権の切り替えはテイク・コマンド・コントロール・パネルによって行われる。", "HSIは、タカンの距離、方位、TO-FROM、コース・ディビエーションを表示する。", "ADIモード選択時HUDは、選択した地上タカン装置までの距離、選択したタカン進入コースに対するバンク・アングル・ステアリング及び選択したタカンモードを表示する。", "STEER MODEスイッチは、ADIの作動モードを選択する。", "テイク・コマンド・コントロール・パネルは、タカン送受信機の制御を前席または後席で実施するかを決定する。"],
    correctOption: 3,
  },
