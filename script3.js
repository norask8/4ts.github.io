...
const questions = [
  ...
  },
  {
    ...
    options: ["IFFとは、あらゆる状況下で、敵か味方かの区別を確実に行うためにある。", "モード５は、2段階の機能を持ち、それぞれをモード5レベル1、モード5レベル2と呼ぶ。レベル1及びレベル2は、それぞれ８通りの送信フォーマットを持つ。", "インタロゲータは、1026MHz及び1034MHzの2周波を使用した最小周波数偏移変調（MSK）方式である。", "トランスポンダは、1086MHz及び1094MHzの2周波を使用したMSK方式によって応答信号を符号化する。"],
    correctOption: 2,
  },
